...
\begin{center}
    \textbf{Summary}
\end{center}
To work at Garmin as a Data Engineer 2. I have experience handling SQL databasese in professional and classroom environments. At Hunter Engineering, we used Microsoft SQL to store car data. In my senior capstone class, my team used PostgreSQL (hosted on my personal server) and MongoDB to store user data.
