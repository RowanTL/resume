...
\begin{itemize}[noitemsep, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=0pt]
    ...
    \item Calculate Optical Flow via MATLAB and C++
\end{itemize}
...
\textbf{Systematic Trading Project} \hfill November 2025 - Present
\begin{itemize}[noitemsep, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=0pt]
    ...
    \item Implement basic backtesting from the ground up
\end{itemize}
...
\begin{center}
    \tiny{Link to this LaTeX resume: https://github.com/RowanTL/resume/blob/main/rga-resume/resume.pdf}
\end{center}
